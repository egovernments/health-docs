...
All file examples in this document refer to the Default branches in the health campaign DevOps and config repositories for the example purposes. If you have replaced these repositories with your fork or clone, please refer the same here.&#x20;
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-04-04 at 5.29.13 PM.png" alt="" width="556"><figcaption></figcaption></figure>
...
* **Import the seed data script**
  * [HCM Setup Script](https://api.postman.com/collections/3048487-78265ba4-6a5b-421c-8a44-30215dfdf02b?access\_key=PMAT-01HTHVETBK363VP9307RFTEHR5) - This collection includes all the scripts to create users,  Projects, staff and product variants
...
**Localisation scripts are** [**here**](https://api.postman.com/collections/1609763-ba6d4d62-f9a1-4047-b6c5-88ce2c3aaf93?access\_key=PMAT-01HTJ08ECWHHJGP975E3GTRV14)**; During local execution, the script fails because of the rate limit exception, but it will execute as expected on the server.**&#x20;
