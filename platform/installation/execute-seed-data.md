...
*   Once Env is selected, click on the imported HCM setup collection, click run&#x20;
...
* Once the script is executed completely, update the following values from the postman environment variable to the project-types.json (**health-campaign-mdms/blob/DEMO/data/mz/health/project-types.json**) master data file - see the [example ](https://github.com/egovernments/health-campaign-mdms/blob/DEMO/data/mz/health/project-types.json#L13)
