...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/iVdFjJNtaUlTFjgyyYVV/community/committee/digital-product-advisory-committee-charter
---
...
Here’s a view of what the Digital Product Advisory Committee (DPAC) is expected to do - <br>
...
The following are a few of the things the Digital Product Advisory Committee will not do:<br>
...
| Name                 | Key Expertise                | Organisation                     |
| -------------------- | ---------------------------- | -------------------------------- |
