...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/iVdFjJNtaUlTFjgyyYVV/community/digit-solutions-support
---
...
{% hint style="info" %}
To escalate a discussion or issue already raised in the GitHub Discussion Board, please email us at [digit-support@egovernments.org](mailto:digit-support@egovernments.org) with your Discussion or Issue ID (as applicable).
{% endhint %}
