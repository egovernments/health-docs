...
The **Language Selection screen** in the DIGIT Health platform allows users to choose their preferred language before accessing application features. This ensures a personalised user experience, supporting multi-lingual interfaces as per the localisation configurations.

<div align="left"><figure><img src="../../../.gitbook/assets/image (189).png" alt="" width="206"><figcaption></figcaption></figure></div>
...
* [Language selection card widget](https://github.com/egovernments/health-campaign-field-worker-app/blob/master/packages/digit_components/lib/widgets/molecules/digit_language_card.dart)
