...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/iVdFjJNtaUlTFjgyyYVV/deploy/configuration/hcm-service-configuration/project-services
---
...
The source code for the Project registry is located in the [Git repository here](https://github.com/egovernments/health-campaign-services/tree/v1.1.0/health-services/project). Clone or download the code from this repository before proceeding.
{% endstep %}
...
| Facility Service   | egov.project.facility.host | [https://health-dev.digit.org](https://health-dev.digit.org) |
...
[Click here to access](https://www.postman.com/sreejith-kanjarla-759135/hcm-collection/folder/n4n55cl/project) the Postman collection.
