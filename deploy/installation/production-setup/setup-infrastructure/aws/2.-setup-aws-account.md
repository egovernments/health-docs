...
* Use the [**AWS IAM User**](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html) **credentials provided** for Terraform and [**AWS - Provision Infrastructure**](3.-aws-provision-infrastructure.md) to connect with your AWS account and provision the cloud resources.
