...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/iVdFjJNtaUlTFjgyyYVV/deploy/installation/setup-project-data
---
...
{% file src="../../.gitbook/assets/Localization_Seed_Script.postman_collection .json" %}
