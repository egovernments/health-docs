...
* Download the `seed_data_dump_1.8.sql` file into your local system and save it in a folder/directory.

{% file src="../../.gitbook/assets/seed_data_dump_v1.8.sql" %}
{% endstep %}
...
<figure><img src="../../.gitbook/assets/image (61).png" alt=""><figcaption><p>Sample screenshot of database pod</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (62).png" alt=""><figcaption><p>Sample Screenshot of command output for db_host</p></figcaption></figure>
{% endstep %}
...
<figure><img src="../../.gitbook/assets/image (63).png" alt=""><figcaption><p>Example screenshot with cd command to download folder</p></figcaption></figure>
