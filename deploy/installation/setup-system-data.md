...
{% file src="../../.gitbook/assets/seed_data_dump_v1.7.sql" %}
{% endstep %}
...
<figure><img src="../../.gitbook/assets/image (5).png" alt=""><figcaption><p>Sample screenshot of database pod</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (6).png" alt=""><figcaption><p>Sample Screenshot of command output for db_host</p></figcaption></figure>
{% endstep %}
...
<figure><img src="../../.gitbook/assets/image (7).png" alt=""><figcaption><p>Example screenshot with cd command to download folder</p></figcaption></figure>
...
{% step %}
### Set up Complaints & Payments workflow
