...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/iVdFjJNtaUlTFjgyyYVV/design/architecture/field-app-architecture
---
...
<figure><img src="../../../.gitbook/assets/hld_lld.png" alt=""><figcaption></figcaption></figure>
...
**Codebase -** [Click here](https://github.com/egovernments/health-campaign-field-worker-app) to access the field app codebase.
...
Since the app is expected to work while users are offline, there is a need to send data that has been collected while the user has been offline to the server.
...
The down sync of the beneficiaries feature is designed to optimise data synchronisation between the local device and the server, specifically focusing on the beneficiary records. This process helps prevent duplicate record creation by different users within the same boundary.

The down sync is initiated by sending a request to the server, providing the boundary code along with offset and limit parameters. The server validates the provided parameters and responds with the total count of beneficiary records within the specified boundary.
...
<figure><img src="../../../.gitbook/assets/service-delivery.png" alt=""><figcaption></figcaption></figure>

### Proximity Based Search

<figure><img src="../../../.gitbook/assets/proximity-based-search.png" alt=""><figcaption></figcaption></figure>
