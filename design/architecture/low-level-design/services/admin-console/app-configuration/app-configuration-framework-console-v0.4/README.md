...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/iVdFjJNtaUlTFjgyyYVV/design/architecture/low-level-design/services/admin-console/app-configuration/technical-documentation-improved
---

# App Configuration Framework - Console v0.4
