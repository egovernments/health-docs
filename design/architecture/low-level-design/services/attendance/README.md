---
description: Update & approve attendance
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/iVdFjJNtaUlTFjgyyYVV/design/architecture/low-level-design/services/attendance
---
...
{% hint style="info" %}
_<mark style="color:red;">**Note:**</mark>_ _In Payments version 0.1, each user will be associated with only one project._
{% endhint %}

## **Sequence Diagram**

<figure><img src="../../../../../.gitbook/assets/image (382).png" alt=""><figcaption><p>Attendance Edit and Approval By Proximity Supervisor</p></figcaption></figure>
