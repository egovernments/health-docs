...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/iVdFjJNtaUlTFjgyyYVV/access/public-health-product-suite/campaign-management-dashboard/integrated-cross-campaign-dashboard-iccd/architecture/low-level-design
---
