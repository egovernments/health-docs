...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/iVdFjJNtaUlTFjgyyYVV/access/public-health-product-suite/health-campaign-management-hcm/hcm-user-manual/common-functions/track-referrals
---
...
{% columns %}
{% column %}
<figure><img src="../../../../../.gitbook/assets/image (349).png" alt="" width="188"><figcaption></figcaption></figure>
{% endcolumn %}

{% column %}
<figure><img src="../../../../../.gitbook/assets/image (351).png" alt="" width="188"><figcaption></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
...
{% columns %}
{% column %}
<figure><img src="../../../../../.gitbook/assets/image (350).png" alt="" width="188"><figcaption></figcaption></figure>
{% endcolumn %}
...
{% columns %}
{% column %}
<figure><img src="../../../../../.gitbook/assets/image (354).png" alt="" width="188"><figcaption></figcaption></figure>
{% endcolumn %}
...
{% column %}
<figure><img src="../../../../../.gitbook/assets/image (357).png" alt="" width="256"><figcaption></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
...
{% columns %}
{% column %}
<figure><img src="../../../../../.gitbook/assets/image (358).png" alt="" width="255"><figcaption></figcaption></figure>
{% endcolumn %}

{% column %}
<figure><img src="../../../../../.gitbook/assets/image (359).png" alt="" width="254"><figcaption></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
