---
description: An illustrative guide to using the Inventory Management feature
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/iVdFjJNtaUlTFjgyyYVV/access/public-health-product-suite/health-campaign-management-hcm/inventory-management
---
...
* [Stock Management](manage-stocks.md)
* [Stock Reconciliation](reconcile-stock.md)
* [View Reports](view-reports.md)
* [Bale Scanning](scan-bales.md)
