---
description: A step-by-step guide for attendance management
---
...
* A **scanner** will open with two options for marking attendance:
  * **Scan QR Code**
  * _(other option to be specified if available)_
...
_QR pop-up to scan the attendee_
...
_Attendee QR code_                                 _Pop-up to confirm the attendee_
