...
1. Training venue/hall with internet connectivity with a capacity of hosting 20 persons.
2. Projector
3. Mic (4)
4. Refreshments and other basic amenities for trainers and trainees.
5. Extension cords (5)
6. Pre-filled registration sheet
7. Agenda printout
8. Training materials soft copy.
9. Training setup/infrastructure readiness on cloud.
10. Training instance setup in the cloud with master data from previous campaigns.
11. Creation of login for different personas in the system for the training.
12. Laptops for the participants (participants to bring their own).
13. Internet

#### Cost Heads

1. eGov’s staff travels, accommodation and transport will be managed by eGov.
2. All other costs will have to be discussed and agreed upon.
...
| 8.00-8.30 AM   | Arrival and Registrations | <ul><li>Registration of participants.</li></ul><ul><li>Crosscheck with the listed names.</li></ul><ul><li>Confirm the mobile number for WhatsApp group formation.</li></ul>                                                                                       |
| 8.30-8.45 AM   | Opening Address           | Introduction by NMCP                                                                                                                                                                                                                                              |
| 8.45-9.30 AM   | Introductions             | <ul><li>Introductions</li></ul><ul><li>Expectations</li></ul><ul><li>Training norms</li></ul><ul><li>Goals and objectives of the training.</li></ul><ul><li>Agenda for the day.</li></ul><p>Pre-test</p>                                                          |
| 9.30-10.15 AM  | Topic 1                   | <p>Campaign overview</p><p><br></p>                                                                                                                                                                                                                               |
| 10.30-11.00 AM | Break                     | <p><br></p>                                                                                                                                                                                                                                                       |
| 11.00-1.00 PM  | Topic 1                   | <ul><li>Overview of HCM and its different users.</li></ul><ul><li>Registration &#x26; distribution.</li></ul><ul><li>Exercises &#x26; role-play.</li></ul>                                                                                                        |
| 1.00-2.00 PM   | Lunch Break               | <p><br></p>                                                                                                                                                                                                                                                       |
| 2.00-2.30 PM   | Topic 2                   | <ul><li>Campaign overview.</li></ul><ul><li>How to use a smartphone.</li></ul><ul><li>Training credentials to be shared, SOP related to mobile device.</li></ul>                                                                                                  |
| 2.30-3.30 PM   | Topic 3                   | <ul><li>Overview of HCM and its different users.</li></ul><ul><li>Registration &#x26; distribution.</li></ul><ul><li>Exercises &#x26; role-play.</li></ul>                                                                                                        |
| 3.30-3.45 PM   | Break                     | <p><br></p>                                                                                                                                                                                                                                                       |
| 3.45-4.45 PM   | Topic 4                   | <p>Overview of HCM and its different users.</p><p>Registration &#x26; distribution.</p><p>Exercises &#x26; role-play.</p>                                                                                                                                         |
| 4.45-5.00 PM   | Feedback                  | <ul><li>Review of the training day.</li></ul><ul><li>Q&#x26;A session.</li></ul>                                                                                                                                                                                  |
| 5.00 PM        | **End of Day 1**          | <p><br></p>                                                                                                                                                                                                                                                       |
| **Day 2**      |                           |                                                                                                                                                                                                                                                                   |
| Duration       | Activity                  | Sub-Activity                                                                                                                                                                                                                                                      |
...
| 1.00-2.00 PM   | Lunch Break               | <p><br></p>                                                                                                                                                                                                                                                       |
| 2.00-3.00 PM   | Mock Training             | <ul><li>Exercise on mock training on registration and delivery.</li></ul>                                                                                                                                                                                         |
